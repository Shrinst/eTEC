...
public class ElectronicApplianceFragment extends Fragment {
    ...
    public String toString() {
        String title = "Aparatos Electronicos";
        return title;
    }
    ...
    private class MyTask extends AsyncTask<RequestPackage, String, String> {
        ...
        protected void onPostExecute(String content) {
            ...
            CustomAdapter customAdapter = new CustomAdapter(ElectronicApplianceFragment.this.getActivity(),productList);
            listView.setAdapter(customAdapter);
        }
